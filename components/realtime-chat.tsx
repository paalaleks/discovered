...
export const RealtimeChat = ({
  ...
  console.log(
    `[RealtimeChat Client] Received roomId: ${roomId}, userId: ${userId}`
  );
  ...
  return (
    <div className="flex flex-col h-full w-full bg-background text-foreground antialiased">
      ...
      <ScrollArea
        ref={containerRef}
        className="flex flex-col-reverse space-y-4 space-y-reverse h-[calc(100vh-8rem)] overflow-y-auto w-full p-4 scrollbar-hide [-ms-overflow-style:none] [scrollbar-width:none]"
      >
